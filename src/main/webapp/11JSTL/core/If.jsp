...
if태그 : 조건을 확인하여 실행여부를 판단한다.
	...
	var : text속성에서 판단할 결과값을 저장한다.
-->
	<!-- 변수 선언 -->
	<c:set var="number" value="100" />
	<c:set var="string" value="JSP" />
	
	<h4>JSTL의 if 태그로 짝수/홀수 판단한기</h4>
	<!--
	if(number%2==0) 와 동일한 조건의 if문으로 해당 조건의 결과가 result에 젖아된다.
	...
	<c:if test="${ not empty param.user }">
		...
		if태그는 else 구문이 별도로 없으므로 not을 통해 else와 같은 구문을 구성해야한다.
		-->
